...
- June (basically 11th cause it makes me seem consistent but actually) 12th:
	...
	- 1:26 AM: I haven't been working for the past 2 (yes 2, the day doesn't end until I go to sleep, so it's just the 25th hour of June 11th) days because I've been doing an RTL project with hardcaml - maybe more on that later.
...
- June 12th (actually):
	...
	I'm thinking single-permit semaphore to make this *effectively* sequential, to get rid of contention and of course acquiring the lock only once for the entire length of the consensus engine (cause we lock and loop through the registry twice, super wasteful)
...
- June 20th
	...
	- 5:37 AM: I understand that I haven't been documenting this - because documenting does nothing but mess with my thought processs - but I'm really going through it in deciding what I should do. 
...
- August 16th
	- I swear I was gonna write a review for this day, but right now it's august 18th and I absolutely cannot remember what I did today 
